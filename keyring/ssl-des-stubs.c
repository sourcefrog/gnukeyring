/* DO NOT EDIT!
   This file was automatically generated by stubgen v2.0.93
   from ssl-des.def  */
...
static void
GLib_CrDS_clean(unsigned short cmd, void *PBP, unsigned short flags)
{
    if (reg_a4 && libref) {
	GLibClose(libref);
	libref = 0;
...
static void *hook
  __attribute__ ((section ("ehook"), unused)) = GLib_CrDS_clean;

#else

static void __attribute__ ((destructor, unused))
GLib_CrDS_clean(void)
{
    if (libref) {
	GLibClose(libref);
	libref = 0;
